...
---
This email was sent from the gregorywilsonjr.com contact form.
    `.trim();

    // Send email via SES
    const command = new SendEmailCommand({
      Source: 'contact@gregorywilsonjr.com',
      Destination: {
        ToAddresses: ['contact@gregorywilsonjr.com'],
      },
      Message: {
        Subject: {
          Data: emailSubject,
            ...
            Data: `
              <html>
                <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                  ...
                  <p style="font-size: 12px; color: #666;">This email was sent from the gregorywilsonjr.com contact form.</p>
                </body>
              </html>
            `,
            Charset: 'UTF-8',
